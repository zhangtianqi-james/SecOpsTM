...
Welcome to the official documentation for **SecOpsTM** — an automated STRIDE threat modeling framework with MITRE ATT&CK mapping, AI-enhanced threat generation, and interactive diagram export.

This documentation covers installation, basic usage, advanced customization, and the full technical architecture.
